...
$authMiddleware = new \Chadicus\Slim\OAuth2\Middleware\Authorization($server, $container);
...
$app->get('/admin/login', 'AddOn\\Authorization\\Controller\\Admin\\Login:indexGet')->setName('admin.login');
$app->get('/admin/oauth2', 'AddOn\\Authorization\\Controller\\Admin\\OAuth2:indexGet')->setName('admin.oauth2');
$app->get('/admin/oauth2/clients', 'AddOn\\Authorization\\Controller\\Admin\\OAuth2:clientsGet')->setName('admin.oauth2.clients');
...
$app->get('/admin/oauth2/clients/add', 'AddOn\\Authorization\\Controller\\Admin\\OAuth2:clientsAddGet')->setName('admin.oauth2.clients.add');
$app->get('/admin/oauth2/clients/delete/{client_id}', 'AddOn\\Authorization\\Controller\\Admin\\OAuth2:clientsDelete')->setName('admin.oauth2.clients.delete');
$app->get('/admin/oauth2/clients/edit/{client_id}', 'AddOn\\Authorization\\Controller\\Admin\\OAuth2:clientsEditGet')->setName('admin.oauth2.clients.edit');
...
$app->put('/oauth2/clients', 'AddOn\\Authorization\\Controller\\OAuth2:clientsCreate')->setName('oauth2.clients.create');
$app->delete('/oauth2/clients/{client_id}', 'AddOn\\Authorization\\Controller\\OAuth2:clientsDelete')->setName('oauth2.clients.delete');
$app->post('/oauth2/clients/{client_id}', 'AddOn\\Authorization\\Controller\\OAuth2:clientsUpdate')->setName('oauth2.clients.update');